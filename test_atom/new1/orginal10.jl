...
roBwC = diagm(0 => [
        1/2,1/2,0, # C=0 (impossible situation)
        0,2/3,1/3, # C=1
        0,1,0, # C=2
        ])

sys_b_c = DiscreteQuantumSystem([var_c], [var_b], roBwC)

roDwBC = diagm(0 => [
        0,1,0, # B=0, D=0 (player wins)
        1,0,0, #B=0, D=1
        1,0,0, #B=0, D=2
        1,0,0, #B=1, D=0
        0,1,0, #B=1, D=1 (player wins)
        1,0,0, #B=1, D=2
        1,0,0, #B=2, D=0
        0,0,1, #B=2, D=1
        0,1,0 #B=2, D=2 (player wins)
        ])
...
sys_f_de = DiscreteQuantumSystem([var_d, var_e], [var_f], roFwDE);
